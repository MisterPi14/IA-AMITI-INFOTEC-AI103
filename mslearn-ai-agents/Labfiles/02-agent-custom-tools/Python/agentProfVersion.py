...
# Add references
from azure.ai.projects import AIProjectClient # sirve para generar agentes y coneccion a foundry
from azure.ai.projects.models import FunctionTool # crear herramientas
from azure.identity import DefaultAzureCredential # loggeo
from azure.ai.projects.models import PromptAgentDefinition # se usa para hacer pormpts mas avenzados se le envian las herramientas desde este 
from openai.types.responses.response_input_param import FunctionCallOutput # obtener respuestas
...
def main():
    ...
    # Se hace cliente del proyecto con esta forma de with
    with (
        ...
        event_tool = FunctionTool( # Define como se obtendra el disparador y que requiere, este
            name="next_visible_event",
            description="Obtener el siguiente evento visible en una locación",
            parameters={
                "type": "object",
                "properties": {
                    "location": {
                        "type": "string",
                        "description": "Continente del siguiente evento"
                    }
                },
                "required": ["location"],
        ...
        agent = project_client.agents.create_version( #Aqui se crea un agente con codigo "desechable", 
