...
def record_greeting(speech_config):
    ...
    speech_config.speech_synthesis_voice_name = "es-es-Tristan:DragonHDLatestNeural"
    ...
    if result.reason == speech_sdk.ResultReason.SynthesizingAudioCompleted:
        print(f"Saludo grabado y gurdado en {output_file}")
        speech_synthesizer == None
    else:
        print("Error grabando el saludo: {}".format(result.reason))
