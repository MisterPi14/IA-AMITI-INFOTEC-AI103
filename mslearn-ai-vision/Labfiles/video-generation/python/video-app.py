...
def main(): 
    ...
    try:       
        ...
        video = client.videos.create(
            ...
            prompt="Una persona caminando en la calle que se convierte en ajolote a mitad del video",
            size="1280x720",
            seconds='4'
        )
        ...
        if video.status == "completed":
            ...
            remixed = remix_video(
                original_video_id,
                "Cambia la paleta de colores del video a un filtro tono sepia"
            )
        ...
        video = generate_video_from_image(
            ...
            prompt="llegan a la ofina varios ajolotes a tomar junta",
            size="1280x720",
            seconds='4'
        )
        if video.status == "completed":
